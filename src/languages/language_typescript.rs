...
pub enum Typescript {
    ...
    LexicalDeclaration = 182,
    VariableDeclarator = 183,
    StatementBlock = 184,
    ElseClause = 185,
    IfStatement = 186,
    SwitchStatement = 187,
    ...
    Expression = 208,
    PrimaryExpression = 209,
    YieldExpression = 210,
    Object = 211,
    ObjectPattern = 212,
    AssignmentPattern = 213,
    ObjectAssignmentPattern = 214,
    Array = 215,
    ArrayPattern = 216,
    GlimmerTemplate = 217,
    GlimmerOpeningTag = 218,
    GlimmerClosingTag = 219,
    ...
    TypeAnnotation = 303,
    MemberExpression3 = 304,
    CallExpression3 = 305,
    Asserts = 306,
    AssertsAnnotation = 307,
    Type2 = 308,
    RequiredParameter2 = 309,
    OptionalParameter2 = 310,
    OptionalType = 311,
    RestType = 312,
    TupleTypeMember = 313,
    ConstructorType = 314,
    ...
    MemberExpression4 = 323,
    SubscriptExpression2 = 324,
    CallExpression4 = 325,
    InstantiationExpression2 = 326,
    TypeQuery = 327,
    IndexTypeQuery = 328,
    LookupType = 329,
    ...
    FunctionType = 352,
    ProgramRepeat1 = 353,
    ExportStatementRepeat1 = 354,
    ExportClauseRepeat1 = 355,
    NamedImportsRepeat1 = 356,
    VariableDeclarationRepeat1 = 357,
    SwitchBodyRepeat1 = 358,
    ObjectRepeat1 = 359,
    ObjectPatternRepeat1 = 360,
    ArrayRepeat1 = 361,
    ArrayPatternRepeat1 = 362,
    GlimmerTemplateRepeat1 = 363,
    SequenceExpressionRepeat1 = 364,
    StringRepeat1 = 365,
    StringRepeat2 = 366,
    TemplateStringRepeat1 = 367,
    ClassBodyRepeat1 = 368,
    FormalParametersRepeat1 = 369,
    ExtendsClauseRepeat1 = 370,
    ImplementsClauseRepeat1 = 371,
    ExtendsTypeClauseRepeat1 = 372,
    EnumBodyRepeat1 = 373,
    TemplateLiteralTypeRepeat1 = 374,
    TypeArgumentsRepeat1 = 375,
    ObjectTypeRepeat1 = 376,
    TypeParametersRepeat1 = 377,
    TupleTypeRepeat1 = 378,
    InterfaceBody = 379,
    PropertyIdentifier = 380,
    ShorthandPropertyIdentifier = 381,
    ShorthandPropertyIdentifierPattern = 382,
    StatementIdentifier = 383,
    ThisType = 384,
    TypeIdentifier = 385,
    Error = 386,
