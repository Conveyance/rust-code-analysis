...
pub enum Tsx {
    ...
    ArrayPattern = 224,
    GlimmerTemplate = 225,
    GlimmerOpeningTag = 226,
    GlimmerClosingTag = 227,
    JsxElement = 228,
    JsxText = 229,
    JsxExpression = 230,
    ...
    AsExpression = 291,
    SatisfiesExpression = 292,
    InstantiationExpression = 293,
    ImportRequireClause = 294,
    ExtendsClause = 295,
    ExtendsClauseSingle = 296,
    ImplementsClause = 297,
    AmbientDeclaration = 298,
    AbstractClassDeclaration = 299,
    Module = 300,
    InternalModule = 301,
    Module3 = 302,
    ImportAlias = 303,
    NestedTypeIdentifier = 304,
    InterfaceDeclaration = 305,
    ExtendsTypeClause = 306,
    EnumDeclaration = 307,
    EnumBody = 308,
    EnumAssignment = 309,
    TypeAliasDeclaration = 310,
    AccessibilityModifier = 311,
    OverrideModifier = 312,
    RequiredParameter = 313,
    OptionalParameter = 314,
    ParameterName = 315,
    OmittingTypeAnnotation = 316,
    AddingTypeAnnotation = 317,
    OptingTypeAnnotation = 318,
    TypeAnnotation = 319,
    MemberExpression3 = 320,
    CallExpression3 = 321,
    Asserts = 322,
    AssertsAnnotation = 323,
    Type2 = 324,
    RequiredParameter2 = 325,
    OptionalParameter2 = 326,
    OptionalType = 327,
    RestType = 328,
    TupleTypeMember = 329,
    ConstructorType = 330,
    PrimaryType = 331,
    TemplateType = 332,
    TemplateLiteralType = 333,
    InferType = 334,
    ConditionalType = 335,
    GenericType = 336,
    TypePredicate = 337,
    TypePredicateAnnotation = 338,
    MemberExpression4 = 339,
    SubscriptExpression2 = 340,
    CallExpression4 = 341,
    InstantiationExpression2 = 342,
    TypeQuery = 343,
    IndexTypeQuery = 344,
    LookupType = 345,
    MappedTypeClause = 346,
    LiteralType = 347,
    UnaryExpression2 = 348,
    ExistentialType = 349,
    FlowMaybeType = 350,
    ParenthesizedType = 351,
    PredefinedType = 352,
    TypeArguments = 353,
    ObjectType = 354,
    CallSignature = 355,
    PropertySignature = 356,
    TypeParameters = 357,
    TypeParameter = 358,
    DefaultType = 359,
    Constraint = 360,
    ConstructSignature = 361,
    IndexSignature = 362,
    ArrayType = 363,
    TupleType = 364,
    ReadonlyType = 365,
    UnionType = 366,
    IntersectionType = 367,
    FunctionType = 368,
    ProgramRepeat1 = 369,
    ExportStatementRepeat1 = 370,
    ExportClauseRepeat1 = 371,
    NamedImportsRepeat1 = 372,
    VariableDeclarationRepeat1 = 373,
    SwitchBodyRepeat1 = 374,
    ObjectRepeat1 = 375,
    ObjectPatternRepeat1 = 376,
    ArrayRepeat1 = 377,
    ArrayPatternRepeat1 = 378,
    GlimmerTemplateRepeat1 = 379,
    JsxElementRepeat1 = 380,
    JsxStringRepeat1 = 381,
    JsxStringRepeat2 = 382,
    SequenceExpressionRepeat1 = 383,
    StringRepeat1 = 384,
    StringRepeat2 = 385,
    TemplateStringRepeat1 = 386,
    ClassBodyRepeat1 = 387,
    FormalParametersRepeat1 = 388,
    JsxStartOpeningElementRepeat1 = 389,
    ExtendsClauseRepeat1 = 390,
    ImplementsClauseRepeat1 = 391,
    ExtendsTypeClauseRepeat1 = 392,
    EnumBodyRepeat1 = 393,
    TemplateLiteralTypeRepeat1 = 394,
    TypeArgumentsRepeat1 = 395,
    ObjectTypeRepeat1 = 396,
    TypeParametersRepeat1 = 397,
    TupleTypeRepeat1 = 398,
    InterfaceBody = 399,
    PropertyIdentifier = 400,
    ShorthandPropertyIdentifier = 401,
    ShorthandPropertyIdentifierPattern = 402,
    StatementIdentifier = 403,
    ThisType = 404,
    TypeIdentifier = 405,
    Error = 406,
